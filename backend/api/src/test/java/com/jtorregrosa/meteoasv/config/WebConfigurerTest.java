...
class WebConfigurerTest {
    ...
    private MeteoasvProperties props;
    ...
    void shouldStartUpProdServletContext() throws ServletException {
        env.setActiveProfiles(MeteoasvConstants.SPRING_PROFILE_PRODUCTION);
    ...
    void shouldStartUpDevServletContext() throws ServletException {
        env.setActiveProfiles(MeteoasvConstants.SPRING_PROFILE_DEVELOPMENT);
